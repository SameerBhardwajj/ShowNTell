...
import { hitChatCount, updateBadgeCount } from "../modules/Home/action";
...
class NotificationServices extends React.Component<AppProps, AppState> {
  ...
  showLocalPush = (payload: any) => {
    PushNotification.localNotification({
      ...
      bigPictureUrl: payload.data.image, // (optional) default: undefined
      ...
      message: payload.data.body, // (required)
...
const mapDispatchToProps = (dispatch: Function) => ({
  hitChatCount: (value: Function) => dispatch(hitChatCount(value)),
